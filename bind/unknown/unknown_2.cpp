...
void bind_unknown_unknown_2(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // tf::Future file: line:539
		pybind11::class_<tf::Future<void>, std::shared_ptr<tf::Future<void>>> cl(M("tf"), "Future_void_t", "");
	...
	{ // tf::CustomGraphBase file: line:30
		pybind11::class_<tf::CustomGraphBase, std::shared_ptr<tf::CustomGraphBase>> cl(M("tf"), "CustomGraphBase", "");
