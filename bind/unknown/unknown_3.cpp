...
// tf::ChromeObserver file: line:230
...
void bind_unknown_unknown_3(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // tf::Notifier file: line:66
		...
		{ // tf::Notifier::Waiter file: line:72
...
;
	...
	// tf::to_string(enum tf::ObserverType) file: line:730
